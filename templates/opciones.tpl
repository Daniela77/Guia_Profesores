<div class= "col-md-6">
	<aside>
		<nav class="menu-vertical">
			<ul>
				<li><a href="index.php?page=adminProfesores" id="adminAgregarProfesor" class="btn btn-info btn-block active">Agregar Profesor</a></li>
				...
				<!-- <li><a href="index.php?page=adminUsuarios" id="adminListaU" class="AdminConfig btn btn-info btn-block active">Administrar Usuarios</a></li> -->
			</ul>
		</nav>
	</aside>
</div>
